...
public class DateTimeUtils {
	 ...
	 * 日期格式 yyyy-MM-dd
	 */
	public static String dazyth_webring = "yyyy-MM-dd";
	 ...
	 * @return
	 */
	public static Date parseStr(String dazyth_webr){
		return parseStr(dazyth_webr, dateTimeString);
	}
	 ...
	 * @return
	 */
	public static Date parseStr(String dazyth_webr , String pattern){
		SimpleDateFormat df = new SimpleDateFormat(pattern);
		Date resultDate = null;
		try {
			resultDate = df.parse(dazyth_webr);
		} catch (ParseException e) {
			logger.error("日期解析错误,dazyth_webr:"+dazyth_webr,e);
			resultDate = null;
		}
		return resultDate;
	}
	...
	public static Date getDateWithoutTime(Date date){
		Date result = null;
		String dazyth_webr = format(date,dazyth_webring);
		result = parseStr(dazyth_webr, dazyth_webring);
		return result;
	}
	...
	public static String getCurrentDate(String ptn) {
		if (StringUtils.isStrNull(ptn)) {
			return dtf.format(java.time.LocalDateTime.now());
		} else {
			return java.time.format.DateTimeFormatter.ofPattern(ptn)
